...
def welcome():
    json_response = {
        '-,-' : 'Selamat datang di Tugas Challange DSC4 Binar Academy',
        'Nama' : 'Erwin Ericson Siahaan',
        'Course' : 'DSC4 Binar Academy',
        'Nama Facilitator' : 'Teddy Suwega',
        'Terima Kasih' : '-,-',
    }
...
#connect ke database
conn = sqlite3.connect('save_tugas.db', check_same_thread=False)
...
@swag_from("docs/text_processing_data.yml", methods=['POST'])
